        ...
        <div className="h-full flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-800 flex-shrink-0">
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={goToday}
                        className="text-xs text-gray-400 hover:text-white bg-[#2a2b2d] border border-gray-700 rounded px-2 py-1 hover:border-gray-500 transition-colors"
                    >
                        Today
                    </button>
                </div>
            ...
            <div className="flex-1 grid grid-cols-7 grid-rows-6 overflow-hidden">
                {calendarDays.map((cell, idx) => {
                    ...
                    return (
                        <div
                            key={idx}
                            className={`border-b border-r border-gray-800 p-1 min-h-0 overflow-hidden ${cell.isCurrentMonth ? 'bg-[#1e1f21]' : 'bg-[#171819]'
                                }`}
                        >
