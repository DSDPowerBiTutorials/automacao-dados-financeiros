...
export default function GoCardlessPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
      <Sidebar currentPage="gocardless" paymentSourceDates={{}} />
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  className="hidden"
                  id="file-upload-gocardless"
                />
                <label htmlFor="file-upload-gocardless">
        ...
        <div className="container mx-auto px-6 py-8">
          <Card className="shadow-xl">
            <CardHeader className="bg-gradient-to-r from-[#1a2b4a] to-[#2c3e5f] text-white">
              <CardTitle>Direct Debit Payment Details</CardTitle>
              <CardDescription className="text-white/80">
                Upload CSV files from GoCardless payment system
              </CardDescription>
            </CardHeader>
