                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                Transações em Euro • {rows.length} registros
                                {lastSyncDate && (
                                    <span className="ml-2">
                ...
                <Card>
                    <CardContent className="pt-4">
                        ...
                        <div className="text-xl font-bold text-green-600">
                            €{stats.totalSales.toLocaleString("pt-PT", { minimumFractionDigits: 2 })}
                        </div>
                ...
                <Card>
                    <CardContent className="pt-4">
                        ...
                        <div className="text-xl font-bold text-red-600">
                            €{stats.totalRefunds.toLocaleString("pt-PT", { minimumFractionDigits: 2 })}
                        </div>
                ...
                <Card>
                    <CardContent className="pt-4">
                        ...
                        <div className={`text-xl font-bold ${stats.netAmount >= 0 ? "text-green-600" : "text-red-600"}`}>
                            €{stats.netAmount.toLocaleString("pt-PT", { minimumFractionDigits: 2 })}
                        </div>
                    </CardContent>
                </Card>
