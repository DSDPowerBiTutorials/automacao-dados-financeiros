...
export default function StripeUSDPage() {
    ...
    const handleAutoReconcile = async () => {
        ...
        try {
            // Fetch bank statements (Bankinter USD)
                    ...
                    const { error: updateError } = await supabase
                        ...
                        .update({
                            ...
                            custom_data: {
                                ...
                                destination_account: "Bankinter USD",
                            },
                        })
                        .eq("id", stripeRow.id);
    ...
    const handleExport = () => {
        ...
        link.href = url;
        link.download = `stripe-usd-${new Date().toISOString().split("T")[0]}.csv`;
        link.click();
