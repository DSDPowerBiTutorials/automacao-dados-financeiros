...
export default function BraintreeGBPPage() {
  ...
  return (
    <div className="min-h-full">
      ...
      >
        <PageHeader title="Braintree GBP - Payment Source" subtitle={`${rows.length} records (${processedRows.length} filtered) - Page ${adjustedCurrentPage} of ${Math.max(1, totalPages)}`}>
            ...
            <CardContent className="p-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-max table-auto">
                  <thead>
                    <tr className="border-b-2 border-[#1a2b4a] bg-gray-50 dark:bg-black">
