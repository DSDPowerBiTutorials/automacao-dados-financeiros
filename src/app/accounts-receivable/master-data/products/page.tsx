...
export default function ProductsPage() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <Button
                            variant="outline"
                            size="sm"
                            className={`bg-transparent border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-[#111111] ${selectedForMerge.length >= 2 ? "text-blue-400" : "text-gray-500"
                                }`}
                            onClick={() => {
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Button
                            ...
                            className={`bg-transparent border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-[#111111] ${showInactive ? "text-yellow-400" : "text-gray-900 dark:text-white"
                                }`}
                        >
            ...
            {/* Table Header */}
            <div className="sticky top-0 z-[5] bg-gray-50 dark:bg-[#0a0a0a] border-b border-gray-200 dark:border-gray-700">
                ...
                {filteredProducts.map((product) => {
                    ...
                    return (
                        <div key={product.id}>
                            {/* Main Product Row */}
                            <div
                                className={`flex items-center gap-1 px-4 py-2 border-b border-gray-200 dark:border-gray-800 hover:bg-gray-100 dark:bg-black/50 ${selectedForMerge.find((p) => p.id === product.id)
                                    ? "bg-blue-900/30"
                                    : ""
                                    }`}
                            >
                                ...
                                <div className="w-[30px] flex-shrink-0">
                                    <input
                                        type="checkbox"
                                        className="rounded bg-gray-100 dark:bg-[#0a0a0a] border-gray-300 dark:border-gray-600"
                                ...
                                <div className="w-[30px] flex-shrink-0">
                                    <button
                                        ...
                                        className="p-1 rounded hover:bg-gray-100 dark:hover:bg-[#111111] text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:text-white"
                                    >
                                ...
                                <div className="w-[100px] flex-shrink-0 flex items-center gap-1">
                                    {hasChildren && (
                                        <button
                                            ...
                                            className="p-0.5 rounded hover:bg-gray-100 dark:hover:bg-[#111111]"
                                        >
                                            {isExpanded ? (
                            ...
                            {hasChildren && isExpanded && (
                                <div className="bg-gray-50 dark:bg-black/30">
                                    {children.map((child) => (
                                        <div
                                            key={child.id}
                                            className="flex items-center gap-1 px-4 py-1.5 border-b border-gray-200 dark:border-gray-800/50 hover:bg-gray-50 dark:bg-black/30"
                                        >
                                            <div className="w-[30px] flex-shrink-0"></div>
                                            <div className="w-[30px] flex-shrink-0"></div>
                                            ...
                                            <div className="w-[60px] flex-shrink-0">
                                                <span className="text-[9px] px-1 py-0.5 rounded bg-gray-100 dark:bg-black text-gray-500">
                                                    Merged
                                                </span>
                                            </div>
                                        </div>
            ...
            <Dialog open={isMergeDialogOpen} onOpenChange={setIsMergeDialogOpen}>
                <DialogContent className="max-w-none max-h-[90vh] bg-gray-50 dark:bg-[#0a0a0a] border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white" style={{ width: '80vw' }}>
                    <DialogHeader>
