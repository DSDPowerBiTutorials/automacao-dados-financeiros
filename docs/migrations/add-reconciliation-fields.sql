...
CREATE INDEX
IF NOT EXISTS idx_invoices_reconciled ON invoices
(is_reconciled) WHERE is_reconciled = TRUE;
CREATE INDEX
IF NOT EXISTS idx_invoices_reconciled_transaction ON invoices
(reconciled_transaction_id) WHERE reconciled_transaction_id IS NOT NULL;
