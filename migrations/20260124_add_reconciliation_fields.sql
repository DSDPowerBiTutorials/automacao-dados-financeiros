...
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS is_reconciled BOOLEAN DEFAULT false;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS reconciled_transaction_id TEXT;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS reconciled_at TIMESTAMPTZ;

-- Create index for reconciliation lookups
CREATE INDEX IF NOT EXISTS idx_invoices_is_reconciled ON invoices(is_reconciled);
CREATE INDEX IF NOT EXISTS idx_invoices_reconciled_transaction ON invoices(reconciled_transaction_id);
